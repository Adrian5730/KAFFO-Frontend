  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="item-modal">
        ...
        <div className="button-container">
          <Button id="cart-button" variant="contained" size="small">
            Agregar al carrito
          </Button>

          <Button id="buy-button" variant="contained" size="small">
            Comprar Ahora
          </Button>
        </div>
      </div>
